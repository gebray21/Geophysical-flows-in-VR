...
{
   // private static TeleportationController instance;
    ...
    private InputAction _thumbstickInputAction = null;
    //private InputActionReference thumbsticReference;
  //  public InputActionReference teleportActive, teleportCancel;

    //Stores Action for Teleport Mode Activate
    private InputAction _teleportActivate = null;
    ...
    void Start()
    {
       ...
       // rayInteractor = GetComponent<XRRayInteractor>();
        ...
        //_teleportActivate = teleportActive.action;
       ...
       // _teleportCancel= teleportCancel;
    ...
    void Update()
    {
        ...
        if (raycastHit.collider.gameObject.tag != "Terrain") //it was Teleport
        {
    ...
    {
        if (!_teleportIsActive && this!=null)
        {
            rayInteractor.enabled = true;
