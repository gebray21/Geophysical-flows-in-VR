...
namespace Breach.WildWaters.Player
{
    ...
    ""controlSchemes"": []
        ...
        private List<ISimulationControlsActions> m_SimulationControlsActionsCallbackInterfaces = new List<ISimulationControlsActions>();
        ...
        public struct SimulationControlsActions
        {
            ...
            public void AddCallbacks(ISimulationControlsActions instance)
            {
                if (instance == null || m_Wrapper.m_SimulationControlsActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_SimulationControlsActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(ISimulationControlsActions instance)
            {
                @PlaySimulation.started -= instance.OnPlaySimulation;
                @PlaySimulation.performed -= instance.OnPlaySimulation;
                @PlaySimulation.canceled -= instance.OnPlaySimulation;
            ...
            public void RemoveCallbacks(ISimulationControlsActions instance)
            {
                if (m_Wrapper.m_SimulationControlsActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(ISimulationControlsActions instance)
            {
                foreach (var item in m_Wrapper.m_SimulationControlsActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_SimulationControlsActionsCallbackInterfaces.Clear();
        ...
        private List<IEditorMovementActions> m_EditorMovementActionsCallbackInterfaces = new List<IEditorMovementActions>();
        ...
        public struct EditorMovementActions
        {
            ...
            public void AddCallbacks(IEditorMovementActions instance)
            {
                if (instance == null || m_Wrapper.m_EditorMovementActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_EditorMovementActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IEditorMovementActions instance)
            {
                @MoveForward.started -= instance.OnMoveForward;
                @MoveForward.performed -= instance.OnMoveForward;
                @MoveForward.canceled -= instance.OnMoveForward;
            ...
            public void RemoveCallbacks(IEditorMovementActions instance)
            {
                if (m_Wrapper.m_EditorMovementActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IEditorMovementActions instance)
            {
                foreach (var item in m_Wrapper.m_EditorMovementActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_EditorMovementActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        ...
        private List<IPlayerUIControlsActions> m_PlayerUIControlsActionsCallbackInterfaces = new List<IPlayerUIControlsActions>();
        ...
        public struct PlayerUIControlsActions
        {
            ...
            public void AddCallbacks(IPlayerUIControlsActions instance)
            {
                if (instance == null || m_Wrapper.m_PlayerUIControlsActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_PlayerUIControlsActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IPlayerUIControlsActions instance)
            {
                @ToggleSimulationUI.started -= instance.OnToggleSimulationUI;
                @ToggleSimulationUI.performed -= instance.OnToggleSimulationUI;
                @ToggleSimulationUI.canceled -= instance.OnToggleSimulationUI;
            ...
            public void RemoveCallbacks(IPlayerUIControlsActions instance)
            {
                if (m_Wrapper.m_PlayerUIControlsActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IPlayerUIControlsActions instance)
            {
                foreach (var item in m_Wrapper.m_PlayerUIControlsActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_PlayerUIControlsActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
